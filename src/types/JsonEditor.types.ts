...
export function isNumberFieldValidations(
	validations: any,
): validations is NumberFieldValidations {
	return (
...
export type JsonEditorContextType = {
	...
	setSelectedFieldsForEditing: React.Dispatch<
...
type StandardEditingConfig = {
	isEditing?: boolean;
	editingMode?:
		| typeof GLOBAL_EDITING_MODE
		| typeof INDIVIDUAL_EDITING_MODE
		| typeof GLOBAL_INDIVIDUAL_EDITING_MODE;
	allFieldsEditable?: boolean;
	editableFields?: EditableFielsdObjectType;
	nonEditableFields?: NonEditableFieldsObjectType;
	debouncing?: boolean;
...
export type DefaultNumberElementProps = Omit<
	DefaultInputField,
	"value" | "readModeValue"
> & {
...
export type DefaultBooleanElementProps = Omit<
	DefaultInputField,
	"value" | "readModeValue"
> & {
